...
export type AcceptNegotiableQuoteTemplateInput = {
...
export type AddRequisitionListItemsToCartOutput = {
  ...
  add_requisition_list_items_to_cart_user_errors: Array<Maybe<AddRequisitionListItemToCartUserError>>;
...
export type ApplyGiftCardToOrder = {
  __typename?: 'ApplyGiftCardToOrder';
...
export type BundleCartItem = CartItemInterface & {
  ...
  max_qty: Maybe<Scalars['Float']['output']>;
  /** Line item min qty in quote template */
  min_qty: Maybe<Scalars['Float']['output']>;
  ...
  note_from_buyer: Maybe<Array<Maybe<ItemNote>>>;
  /** The seller's quote line item note. */
  note_from_seller: Maybe<Array<Maybe<ItemNote>>>;
...
export type BundleOrderItem = OrderItemInterface & {
  ...
  quantity_return_requested: Maybe<Scalars['Float']['output']>;
...
export type BundleProduct = CustomizableProductInterface & PhysicalProductInterface & ProductInterface & RoutableInterface & {
   ...
   * @deprecated Use Adobe Commerce `custom_attributesV2` query instead
   */
  ...
  gift_wrapping_available: Scalars['Boolean']['output'];
  /** Returns value and currency indicating gift wrapping price for the product. */
  gift_wrapping_price: Maybe<Money>;
  /** @deprecated Use the `custom_attributes` field instead. */
...
export type CancelNegotiableQuoteTemplateInput = {
  ...
  cancellation_comment: InputMaybe<Scalars['String']['input']>;
  /** The unique ID of a `NegotiableQuoteTemplate` object. */
  template_id: Scalars['ID']['input'];
};
...
export type Cart = {
  ...
  /** The total number of items in the cart. */
  total_summary_quantity_including_config: Scalars['Float']['output'];
};
...
export type CloseNegotiableQuoteError = InternalError | NegotiableQuoteInvalidStateError | NoSuchEntityUidError;
...
export type CloseNegotiableQuoteOperationFailure = {
  ...
  quote_uid: Scalars['ID']['output'];
};

export type CloseNegotiableQuoteOperationResult = CloseNegotiableQuoteOperationFailure | NegotiableQuoteUidOperationSuccess;
...
export type CloseNegotiableQuotesOutput = {
  ...
  operation_results: Array<Maybe<CloseNegotiableQuoteOperationResult>>;
...
export enum CompaniesSortFieldEnum {
...
export type CompanyInvitationOutput = {
  __typename?: 'CompanyInvitationOutput';
...
export type CompanyTeam = {
  ...
  structure_id: Scalars['ID']['output'];
};
...
export type Customer = {
  ...
  purchase_order_approval_rule: Maybe<PurchaseOrderApprovalRule>;
  /** Purchase order approval rule metadata that can be used for rule edit form rendering. */
  purchase_order_approval_rule_metadata: Maybe<PurchaseOrderApprovalRuleMetadata>;
  /** A list of purchase order approval rules visible to the customer. */
  purchase_order_approval_rules: Maybe<PurchaseOrderApprovalRules>;
  /** A list of purchase orders visible to the customer. */
  purchase_orders: Maybe<PurchaseOrders>;
  ...
  purchase_orders_enabled: Scalars['Boolean']['output'];
...
export type CustomerCompaniesArgs = {
  input: InputMaybe<UserCompaniesInput>;
};
...
/** Defines the customer name, addresses, and other details. */
export type CustomerPurchase_OrderArgs = {
  uid: Scalars['ID']['input'];
};


/** Defines the customer name, addresses, and other details. */
export type CustomerPurchase_Order_Approval_RuleArgs = {
  uid: Scalars['ID']['input'];
};


/** Defines the customer name, addresses, and other details. */
export type CustomerPurchase_Order_Approval_RulesArgs = {
  currentPage?: InputMaybe<Scalars['Int']['input']>;
  pageSize?: InputMaybe<Scalars['Int']['input']>;
};
...
/** Defines the customer name, addresses, and other details. */
export type CustomerPurchase_OrdersArgs = {
  currentPage?: InputMaybe<Scalars['Int']['input']>;
...
export type CustomerOrder = {
  ...
  applied_gift_cards: Maybe<Array<Maybe<ApplyGiftCardToOrder>>>;
...
export type CustomerToken = {
  ...
  customer_token_lifetime: Maybe<Scalars['Int']['output']>;
...
export type DeleteNegotiableQuoteError = InternalError | NegotiableQuoteInvalidStateError | NoSuchEntityUidError;
...
export type DeleteNegotiableQuoteOperationResult = DeleteNegotiableQuoteOperationFailure | NegotiableQuoteUidOperationSuccess;

/** Specifies the quote template id of the quote template to delete */
export type DeleteNegotiableQuoteTemplateInput = {
  /** The unique ID of a `NegotiableQuoteTemplate` object. */
  template_id: Scalars['ID']['input'];
};

/** Contains details about a failed delete operation on a negotiable quote template. */
export type DeleteNegotiableQuoteTemplateOutput = {
  __typename?: 'DeleteNegotiableQuoteTemplateOutput';
...
export type DeleteNegotiableQuotesOutput = {
  ...
  operation_results: Array<Maybe<DeleteNegotiableQuoteOperationResult>>;
...
export type Discount = {
  ...
  is_discounting_locked: Maybe<Scalars['Boolean']['output']>;
...
export type DuplicateNegotiableQuoteInput = {
  ...
  duplicated_quote_uid: Scalars['ID']['input'];
...
export type DuplicateNegotiableQuoteOutput = {
  __typename?: 'DuplicateNegotiableQuoteOutput';
...
export type DynamicBlocksFilterInput = {
  ...
  product_uid: InputMaybe<Scalars['ID']['input']>;
...
export type GenerateNegotiableQuoteFromTemplateInput = {
  /** The unique ID of a `NegotiableQuoteTemplate` object. */
  template_id: Scalars['ID']['input'];
};

/** Contains the generated negotiable quote id. */
export type GenerateNegotiableQuoteFromTemplateOutput = {
  __typename?: 'GenerateNegotiableQuoteFromTemplateOutput';
  /** The unique ID of a generated `NegotiableQuote` object. */
  negotiable_quote_uid: Scalars['ID']['output'];
};
...
export type GiftOptionsPrices = {
  ...
  gift_wrapping_for_items_incl_tax: Maybe<Money>;
...
export type ItemNote = {
  ...
  creator_type: Maybe<Scalars['Int']['output']>;
  /** The unique ID of a `CartItemInterface` object. */
  negotiable_quote_item_uid: Maybe<Scalars['ID']['output']>;
  /** Note text. */
  note: Maybe<Scalars['String']['output']>;
  /** The unique ID of a `ItemNote` object. */
  note_uid: Maybe<Scalars['ID']['output']>;
};
...
export type MoveLineItemToRequisitionListInput = {
  ...
  requisition_list_uid: Scalars['ID']['input'];
};

/** Contains the updated negotiable quote. */
export type MoveLineItemToRequisitionListOutput = {
  __typename?: 'MoveLineItemToRequisitionListOutput';
...
export type Mutation = {
  ...
  acceptCompanyInvitation: Maybe<CompanyInvitationOutput>;
  /** Update an existing negotiable quote template. */
  acceptNegotiableQuoteTemplate: Maybe<NegotiableQuoteTemplate>;
  ...
  cancelNegotiableQuoteTemplate: Maybe<NegotiableQuoteTemplate>;
  ...
  /** Confirm the return. */
  confirmReturn: Maybe<RequestReturnOutput>;
   ...
   * @deprecated Use deleteCompanyUserV2 instead. The current method only deactivates the user account associated with the company.
   */
  deleteCompanyUser: Maybe<DeleteCompanyUserOutput>;
  /** Delete the specified company user. */
  deleteCompanyUserV2: Maybe<DeleteCompanyUserOutput>;
  ...
  deleteNegotiableQuoteTemplate: Scalars['Boolean']['output'];
  ...
  /** Negotiable Quote resulting from duplication operation. */
  duplicateNegotiableQuote: Maybe<DuplicateNegotiableQuoteOutput>;
  ...
  generateNegotiableQuoteFromTemplate: Maybe<GenerateNegotiableQuoteFromTemplateOutput>;
  ...
  moveLineItemToRequisitionList: Maybe<MoveLineItemToRequisitionListOutput>;
  ...
  openNegotiableQuoteTemplate: Maybe<NegotiableQuoteTemplate>;
  ...
  removeNegotiableQuoteTemplateItems: Maybe<NegotiableQuoteTemplate>;
  ...
  renameNegotiableQuote: Maybe<RenameNegotiableQuoteOutput>;
  ...
  requestGuestReturn: Maybe<RequestReturnOutput>;
  /** Request a new negotiable quote on behalf of the buyer. */
  requestNegotiableQuote: Maybe<RequestNegotiableQuoteOutput>;
  /** Request a new negotiable quote on behalf of the buyer. */
  requestNegotiableQuoteTemplateFromQuote: Maybe<NegotiableQuoteTemplate>;
  ...
  setNegotiableQuoteTemplateShippingAddress: Maybe<NegotiableQuoteTemplate>;
  /**
  ...
  setQuoteTemplateLineItemNote: Maybe<NegotiableQuoteTemplate>;
  ...
  submitNegotiableQuoteTemplateForReview: Maybe<NegotiableQuoteTemplate>;
  ...
  trackViewedProduct: Maybe<Scalars['Boolean']['output']>;
  ...
  updateNegotiableQuoteTemplateQuantities: Maybe<UpdateNegotiableQuoteTemplateItemsQuantityOutput>;
...
export type MutationAcceptNegotiableQuoteTemplateArgs = {
...
export type MutationAddPurchaseOrderCommentArgs = {
  input: AddPurchaseOrderCommentInput;
};


export type MutationAddPurchaseOrderItemsToCartArgs = {
...
export type MutationApprovePurchaseOrdersArgs = {
...
export type MutationCancelNegotiableQuoteTemplateArgs = {
...
export type MutationCancelPurchaseOrdersArgs = {
  input: PurchaseOrdersActionInput;
};
...
export type MutationConfirmReturnArgs = {
...
export type MutationCreatePurchaseOrderApprovalRuleArgs = {
...
export type MutationDeleteCompanyUserV2Args = {
  id: Scalars['ID']['input'];
};
...
export type MutationDeleteNegotiableQuoteTemplateArgs = {
...
export type MutationDeletePurchaseOrderApprovalRuleArgs = {
...
export type MutationDuplicateNegotiableQuoteArgs = {
...
export type MutationGenerateNegotiableQuoteFromTemplateArgs = {
...
export type MutationMoveLineItemToRequisitionListArgs = {
...
export type MutationOpenNegotiableQuoteTemplateArgs = {
  input: OpenNegotiableQuoteTemplateInput;
};


export type MutationPlaceNegotiableQuoteOrderArgs = {
...
export type MutationPlaceOrderForPurchaseOrderArgs = {
  input: PlaceOrderForPurchaseOrderInput;
};


export type MutationPlacePurchaseOrderArgs = {
...
export type MutationRejectPurchaseOrdersArgs = {
  input: PurchaseOrdersActionInput;
};
...
export type MutationRemoveNegotiableQuoteTemplateItemsArgs = {
...
export type MutationRenameNegotiableQuoteArgs = {
...
export type MutationRequestGuestReturnArgs = {
...
export type MutationRequestNegotiableQuoteTemplateFromQuoteArgs = {
...
export type MutationSetLineItemNoteArgs = {
  input: LineItemNoteInput;
};


export type MutationSetNegotiableQuoteBillingAddressArgs = {
  input: SetNegotiableQuoteBillingAddressInput;
};


export type MutationSetNegotiableQuotePaymentMethodArgs = {
...
export type MutationSetNegotiableQuoteShippingMethodsArgs = {
  input: SetNegotiableQuoteShippingMethodsInput;
};


export type MutationSetNegotiableQuoteTemplateShippingAddressArgs = {
...
export type MutationSetQuoteTemplateLineItemNoteArgs = {
...
export type MutationSubmitNegotiableQuoteTemplateForReviewArgs = {
...
export type MutationTrackViewedProductArgs = {
  sku: Scalars['String']['input'];
};
...
export type MutationUpdateNegotiableQuoteTemplateQuantitiesArgs = {
...
export type MutationUpdatePurchaseOrderApprovalRuleArgs = {
...
export type MutationValidatePurchaseOrdersArgs = {
...
export type NegotiableQuote = {
  ...
  billing_address: Maybe<NegotiableQuoteBillingAddress>;
  ...
  shipping_addresses: Array<Maybe<NegotiableQuoteShippingAddress>>;
...
export type NegotiableQuoteAddressInterface = {
...
export type NegotiableQuoteBillingAddress = NegotiableQuoteAddressInterface & {
...
export type NegotiableQuoteInvalidStateError = ErrorInterface & {
...
export type NegotiableQuoteReferenceDocumentLink = {
  __typename?: 'NegotiableQuoteReferenceDocumentLink';
  /** The identifier of the reference document. */
  document_identifier: Maybe<Scalars['String']['output']>;
  ...
  reference_document_url: Scalars['String']['output'];
};

export type NegotiableQuoteShippingAddress = NegotiableQuoteAddressInterface & {
...
export type NegotiableQuoteTemplate = {
  __typename?: 'NegotiableQuoteTemplate';
  /** The first and last name of the buyer. */
  buyer: NegotiableQuoteUser;
  /** A list of comments made by the buyer and seller. */
  comments: Maybe<Array<Maybe<NegotiableQuoteComment>>>;
  ...
  is_min_max_qty_used: Scalars['Boolean']['output'];
  ...
  max_order_commitment: Scalars['Int']['output'];
  /** Commitment for minimum orders */
  min_order_commitment: Scalars['Int']['output'];
  /** The title assigned to the negotiable quote template. */
  name: Scalars['String']['output'];
  /** A list of notifications for the negotiable quote template. */
  notifications: Maybe<Array<Maybe<QuoteTemplateNotificationMessage>>>;
  ...
  reference_document_links: Maybe<Array<Maybe<NegotiableQuoteReferenceDocumentLink>>>;
...
/** Defines a filter to limit the negotiable quotes to return. */
export type NegotiableQuoteTemplateFilterInput = {
  /** Filter by state of one or more negotiable quote templates. */
  state: InputMaybe<FilterEqualTypeInput>;
...
export type NegotiableQuoteTemplateGridItem = {
  __typename?: 'NegotiableQuoteTemplateGridItem';
  /** The date and time the negotiable quote template was activated. */
  activated_at: Scalars['String']['output'];
...
export type NegotiableQuoteTemplateReferenceDocumentLinkInput = {
  /** The identifier of the reference document. */
  document_identifier: InputMaybe<Scalars['String']['input']>;
  /** The title of the reference document. */
  document_name: Scalars['String']['input'];
  /** The unique ID of a `NegotiableQuoteReferenceDocumentLink` object. */
  link_id: InputMaybe<Scalars['ID']['input']>;
  /** The URL of the reference document. */
  reference_document_url: Scalars['String']['input'];
};
...
export enum NegotiableQuoteTemplateSortableField {
...
export type NegotiableQuoteTemplatesOutput = {
  __typename?: 'NegotiableQuoteTemplatesOutput';
  /** A list of negotiable quote templates */
  items: Array<Maybe<NegotiableQuoteTemplateGridItem>>;
  /** Contains pagination metadata */
  page_info: SearchResultPageInfo;
...
export type NegotiableQuoteUidNonFatalResultInterface = {
  /** The unique ID of a `NegotiableQuote` object. */
  quote_uid: Scalars['ID']['output'];
};

/** Contains details about a successful operation on a negotiable quote. */
export type NegotiableQuoteUidOperationSuccess = NegotiableQuoteUidNonFatalResultInterface & {
...
export type OpenNegotiableQuoteTemplateInput = {
  /** The unique ID of a `NegotiableQuoteTemplate` object. */
  template_id: Scalars['ID']['input'];
};
...
export type OrderTotal = {
  ...
  total_reward_points: Maybe<Money>;
  /** The shipping amount for the order. */
  total_shipping: Money;
  /** The total store credit applied to the order. */
  total_store_credit: Maybe<Money>;
...
export type PlaceNegotiableQuoteOrderInput = {
  /** The unique ID of a `NegotiableQuote` object. */
  quote_uid: Scalars['ID']['input'];
};

/** An output object that returns the generated order. */
export type PlaceNegotiableQuoteOrderOutput = {
...
export type PlaceOrderForPurchaseOrderInput = {
  /** The unique ID of a purchase order. */
  purchase_order_uid: Scalars['ID']['input'];
};
...
export type PurchaseOrder = {
  ...
  approval_flow: Array<Maybe<PurchaseOrderRuleApprovalFlow>>;
  /** Purchase order actions available to the customer. Can be used to display action buttons on the client. */
  available_actions: Array<Maybe<PurchaseOrderAction>>;
  ...
  created_by: Maybe<Customer>;
  /** The log of the events related to the purchase order. */
  history_log: Array<Maybe<PurchaseOrderHistoryItem>>;
...
export type PurchaseOrderApprovalRuleConditionAmount = PurchaseOrderApprovalRuleConditionInterface & {
...
export type PurchaseOrderApprovalRuleConditionInterface = {
  /** The type of purchase order approval rule. */
  attribute: Maybe<PurchaseOrderApprovalRuleType>;
  /** The operator to be used for evaluating the approval rule condition. */
  operator: Maybe<PurchaseOrderApprovalRuleConditionOperator>;
...
export enum PurchaseOrderApprovalRuleConditionOperator {
  ...
  MoreThan = 'MORE_THAN',
  MoreThanOrEqualTo = 'MORE_THAN_OR_EQUAL_TO'
}

/** Contains approval rule condition details, including the quantity to be evaluated. */
export type PurchaseOrderApprovalRuleConditionQuantity = PurchaseOrderApprovalRuleConditionInterface & {
...
export enum PurchaseOrderErrorType {
  CouldNotSave = 'COULD_NOT_SAVE',
  NotFound = 'NOT_FOUND',
  NotValidData = 'NOT_VALID_DATA',
  OperationNotApplicable = 'OPERATION_NOT_APPLICABLE',
  Undefined = 'UNDEFINED'
}
...
export type PurchaseOrdersActionOutput = {
  ...
  purchase_orders: Array<Maybe<PurchaseOrder>>;
};
...
export type Query = {
   ...
   * @deprecated Use Adobe Commerce `customAttributeMetadataV2` query instead
   */
  ...
  negotiableQuoteTemplate: Maybe<NegotiableQuoteTemplate>;
  /** Return a list of negotiable quote templates that can be viewed by the logged-in customer. */
  negotiableQuoteTemplates: Maybe<NegotiableQuoteTemplatesOutput>;
  ...
  robotsConfig: Maybe<RobotsConfig>;
...
export type QueryAttributesMetadataArgs = {
  attributeUids: InputMaybe<Array<Scalars['ID']['input']>>;
  entityType: AttributeEntityTypeEnum;
  showSystemAttributes: InputMaybe<Scalars['Boolean']['input']>;
};
...
export type QueryNegotiableQuoteTemplateArgs = {
  templateId: Scalars['ID']['input'];
};


export type QueryNegotiableQuoteTemplatesArgs = {
  currentPage?: InputMaybe<Scalars['Int']['input']>;
  filter: InputMaybe<NegotiableQuoteTemplateFilterInput>;
  pageSize?: InputMaybe<Scalars['Int']['input']>;
  sort: InputMaybe<NegotiableQuoteTemplateSortInput>;
};
...
export type QuoteTemplateNotificationMessage = {
  __typename?: 'QuoteTemplateNotificationMessage';
...
export type RemoveNegotiableQuoteTemplateItemsInput = {
  /** An array of IDs indicating which items to remove from the negotiable quote. */
  item_uids: Array<InputMaybe<Scalars['ID']['input']>>;
  /** The unique ID of a `NegotiableQuoteTemplate` object. */
  template_id: Scalars['ID']['input'];
};
...
export type RenameNegotiableQuoteInput = {
  ...
  quote_comment: InputMaybe<Scalars['String']['input']>;
...
/** Contains the updated negotiable quote. */
export type RenameNegotiableQuoteOutput = {
  __typename?: 'RenameNegotiableQuoteOutput';
...
export type RequestNegotiableQuoteTemplateInput = {
...
export type RobotsConfig = {
  __typename?: 'RobotsConfig';
  customInstructions: Maybe<Scalars['String']['output']>;
  defaultRobots: Maybe<Scalars['String']['output']>;
};
...
export type SearchTerm = {
  ...
  query_text: Maybe<Scalars['String']['output']>;
...
/** Contains the updated negotiable quote. */
export type SetLineItemNoteOutput = {
...
export type SetNegotiableQuotePaymentMethodOutput = {
...
export type SetNegotiableQuoteShippingAddressInput = {
  ...
  shipping_addresses: InputMaybe<Array<InputMaybe<NegotiableQuoteShippingAddressInput>>>;
};
...
/** Contains the negotiable quote. */
export type SetNegotiableQuoteShippingMethodsOutput = {
...
export type StoreConfig = {
  ...
  /** Indicates whether category canonical url is enabled/disabled */
  category_canonical_tag: Maybe<Scalars['Boolean']['output']>;
   ...
   * @deprecated Use printed_card_priceV2 instead
   */
  printed_card_price: Maybe<Scalars['String']['output']>;
  /** The default price of a printed card that accompanies an order. */
  printed_card_priceV2: Maybe<Money>;
  /** Indicates whether product canonical url is enabled/disabled */
  product_canonical_tag: Maybe<Scalars['Boolean']['output']>;
  ...
  quickorder_active: Scalars['Boolean']['output'];
...
export type SubmitNegotiableQuoteTemplateForReviewInput = {
  ...
  /** Commitment for maximum orders */
  max_order_commitment: InputMaybe<Scalars['Int']['input']>;
  /** Commitment for minimum orders */
  min_order_commitment: InputMaybe<Scalars['Int']['input']>;
  /** The title assigned to the negotiable quote template. */
  name: InputMaybe<Scalars['String']['input']>;
  /** An array of reference document links to add to the negotiable quote template. */
  reference_document_links: InputMaybe<Array<InputMaybe<NegotiableQuoteTemplateReferenceDocumentLinkInput>>>;
  /** The unique ID of a `NegotiableQuoteTemplate` object. */
  template_id: Scalars['ID']['input'];
};
...
export type UiAttributeTypeAny = UiInputTypeInterface & {
  ...
  is_html_allowed: Maybe<Scalars['Boolean']['output']>;
  /** The frontend input type of the attribute. */
...
export type UpdateNegotiableQuoteTemplateItemsQuantityOutput = {
  __typename?: 'UpdateNegotiableQuoteTemplateItemsQuantityOutput';
  /** The updated negotiable quote template. */
  quote_template: Maybe<NegotiableQuoteTemplate>;
};

/** Specifies the items to update. */
export type UpdateNegotiableQuoteTemplateQuantitiesInput = {
  /** An array of items to update. */
  items: Array<InputMaybe<NegotiableQuoteTemplateItemQuantityInput>>;
  /** The unique ID of a `NegotiableQuoteTemplate` object. */
  template_id: Scalars['ID']['input'];
};
...
export type CurrencyFragmentFragment = { __typename?: 'Currency', available_currency_codes: Array<string | null> | null, default_display_currency_code: string | null } & { ' $fragmentName'?: 'CurrencyFragmentFragment' };

export type StoreConfigFragmentFragment = { __typename?: 'StoreConfig', header_logo_src: string | null, logo_alt: string | null, logo_height: number | null, logo_width: number | null } & { ' $fragmentName'?: 'StoreConfigFragmentFragment' };

export type NavigationMenuFragmentFragment = { __typename?: 'CategoryResult', items: Array<{ __typename?: 'CategoryTree', children_count: string | null, children: Array<{ __typename?: 'CategoryTree', uid: string, level: number | null, name: string | null, url_path: string | null, url_key: string | null, position: number | null, children_count: string | null, children: Array<{ __typename?: 'CategoryTree', uid: string, level: number | null, name: string | null, url_path: string | null, url_key: string | null, position: number | null } | null> | null } | null> | null } | null> | null } & { ' $fragmentName'?: 'NavigationMenuFragmentFragment' };

export type AvailableStoreFragmentFragment = { __typename?: 'StoreConfig', store_code: string | null, store_name: string | null, is_default_store: boolean | null } & { ' $fragmentName'?: 'AvailableStoreFragmentFragment' };

export type GetHeaderDataQueryVariables = Exact<{ [key: string]: never; }>;


export type GetHeaderDataQuery = { __typename?: 'Query', storeConfig: (
    { __typename?: 'StoreConfig' }
    & { ' $fragmentRefs'?: { 'StoreConfigFragmentFragment': StoreConfigFragmentFragment } }
  ) | null, availableStores: Array<(
    { __typename?: 'StoreConfig' }
    & { ' $fragmentRefs'?: { 'AvailableStoreFragmentFragment': AvailableStoreFragmentFragment } }
  ) | null> | null, currency: (
    { __typename?: 'Currency' }
    & { ' $fragmentRefs'?: { 'CurrencyFragmentFragment': CurrencyFragmentFragment } }
  ) | null, categories: (
    { __typename?: 'CategoryResult' }
...
export type CreateCustomerMutation = { __typename?: 'Mutation', createCustomerV2: { __typename?: 'CustomerOutput', customer: { __typename?: 'Customer', firstname: string | null, lastname: string | null, email: string | null, is_subscribed: boolean | null } } | null };

export type GetRecaptchaConfigQueryVariables = Exact<{
  formType: ReCaptchaFormEnum;
}>;


export type GetRecaptchaConfigQuery = { __typename?: 'Query', recaptchaFormConfig: { __typename?: 'ReCaptchaConfigOutput', is_enabled: boolean, configurations: { __typename?: 'ReCaptchaConfiguration', website_key: string, badge_position: string | null } | null } | null };

export type GetHeaderCustomerQueryVariables = Exact<{ [key: string]: never; }>;


export type GetHeaderCustomerQuery = { __typename?: 'Query', customer: { __typename?: 'Customer', firstname: string | null, lastname: string | null } | null };

export type GetBasicCustomerInfoQueryVariables = Exact<{ [key: string]: never; }>;


export type GetBasicCustomerInfoQuery = { __typename?: 'Query', customer: { __typename?: 'Customer', firstname: string | null } | null };

export type GetNavigationMenuQueryVariables = Exact<{ [key: string]: never; }>;


export type GetNavigationMenuQuery = { __typename?: 'Query', categories: { __typename?: 'CategoryResult', items: Array<{ __typename?: 'CategoryTree', children_count: string | null, children: Array<{ __typename?: 'CategoryTree', uid: string, level: number | null, name: string | null, url_path: string | null, url_key: string | null, position: number | null, children_count: string | null, children: Array<{ __typename?: 'CategoryTree', uid: string, level: number | null, name: string | null, url_path: string | null, url_key: string | null, position: number | null } | null> | null } | null> | null } | null> | null } | null };

export type GetStoreConfigQueryVariables = Exact<{ [key: string]: never; }>;


export type GetStoreConfigQuery = { __typename?: 'Query', storeConfig: { __typename?: 'StoreConfig', header_logo_src: string | null, logo_alt: string | null, logo_height: number | null, logo_width: number | null } | null, availableStores: Array<(
    { __typename?: 'StoreConfig' }
    & { ' $fragmentRefs'?: { 'AvailableStoreFragmentFragment': AvailableStoreFragmentFragment } }
  ) | null> | null, currency: (
    { __typename?: 'Currency' }
...
export const CurrencyFragmentFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"CurrencyFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Currency"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"available_currency_codes"}},{"kind":"Field","name":{"kind":"Name","value":"default_display_currency_code"}}]}}]} as unknown as DocumentNode<CurrencyFragmentFragment, unknown>;
export const StoreConfigFragmentFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"StoreConfigFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"StoreConfig"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"header_logo_src"}},{"kind":"Field","name":{"kind":"Name","value":"logo_alt"}},{"kind":"Field","name":{"kind":"Name","value":"logo_height"}},{"kind":"Field","name":{"kind":"Name","value":"logo_width"}}]}}]} as unknown as DocumentNode<StoreConfigFragmentFragment, unknown>;
export const NavigationMenuFragmentFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"NavigationMenuFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"CategoryResult"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"items"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"children_count"}},{"kind":"Field","name":{"kind":"Name","value":"children"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"uid"}},{"kind":"Field","name":{"kind":"Name","value":"level"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"url_path"}},{"kind":"Field","name":{"kind":"Name","value":"url_key"}},{"kind":"Field","name":{"kind":"Name","value":"position"}},{"kind":"Field","name":{"kind":"Name","value":"children_count"}},{"kind":"Field","name":{"kind":"Name","value":"children"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"uid"}},{"kind":"Field","name":{"kind":"Name","value":"level"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"url_path"}},{"kind":"Field","name":{"kind":"Name","value":"url_key"}},{"kind":"Field","name":{"kind":"Name","value":"position"}}]}}]}}]}}]}}]} as unknown as DocumentNode<NavigationMenuFragmentFragment, unknown>;
export const AvailableStoreFragmentFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"AvailableStoreFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"StoreConfig"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"store_code"}},{"kind":"Field","name":{"kind":"Name","value":"store_name"}},{"kind":"Field","name":{"kind":"Name","value":"is_default_store"}}]}}]} as unknown as DocumentNode<AvailableStoreFragmentFragment, unknown>;
export const GetHeaderDataDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetHeaderData"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"storeConfig"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"StoreConfigFragment"}}]}},{"kind":"Field","name":{"kind":"Name","value":"availableStores"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"AvailableStoreFragment"}}]}},{"kind":"Field","name":{"kind":"Name","value":"currency"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"CurrencyFragment"}}]}},{"kind":"Field","name":{"kind":"Name","value":"categories"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"NavigationMenuFragment"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"StoreConfigFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"StoreConfig"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"header_logo_src"}},{"kind":"Field","name":{"kind":"Name","value":"logo_alt"}},{"kind":"Field","name":{"kind":"Name","value":"logo_height"}},{"kind":"Field","name":{"kind":"Name","value":"logo_width"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"AvailableStoreFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"StoreConfig"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"store_code"}},{"kind":"Field","name":{"kind":"Name","value":"store_name"}},{"kind":"Field","name":{"kind":"Name","value":"is_default_store"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"CurrencyFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Currency"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"available_currency_codes"}},{"kind":"Field","name":{"kind":"Name","value":"default_display_currency_code"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"NavigationMenuFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"CategoryResult"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"items"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"children_count"}},{"kind":"Field","name":{"kind":"Name","value":"children"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"uid"}},{"kind":"Field","name":{"kind":"Name","value":"level"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"url_path"}},{"kind":"Field","name":{"kind":"Name","value":"url_key"}},{"kind":"Field","name":{"kind":"Name","value":"position"}},{"kind":"Field","name":{"kind":"Name","value":"children_count"}},{"kind":"Field","name":{"kind":"Name","value":"children"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"uid"}},{"kind":"Field","name":{"kind":"Name","value":"level"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"url_path"}},{"kind":"Field","name":{"kind":"Name","value":"url_key"}},{"kind":"Field","name":{"kind":"Name","value":"position"}}]}}]}}]}}]}}]} as unknown as DocumentNode<GetHeaderDataQuery, GetHeaderDataQueryVariables>;
...
export const CreateCustomerDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateCustomer"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"firstname"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"lastname"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"email"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"password"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"is_subscribed"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createCustomerV2"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"firstname"},"value":{"kind":"Variable","name":{"kind":"Name","value":"firstname"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"lastname"},"value":{"kind":"Variable","name":{"kind":"Name","value":"lastname"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"email"},"value":{"kind":"Variable","name":{"kind":"Name","value":"email"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"password"},"value":{"kind":"Variable","name":{"kind":"Name","value":"password"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"is_subscribed"},"value":{"kind":"Variable","name":{"kind":"Name","value":"is_subscribed"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"customer"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"firstname"}},{"kind":"Field","name":{"kind":"Name","value":"lastname"}},{"kind":"Field","name":{"kind":"Name","value":"email"}},{"kind":"Field","name":{"kind":"Name","value":"is_subscribed"}}]}}]}}]}}]} as unknown as DocumentNode<CreateCustomerMutation, CreateCustomerMutationVariables>;
export const GetRecaptchaConfigDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetRecaptchaConfig"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"formType"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ReCaptchaFormEnum"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"recaptchaFormConfig"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"formType"},"value":{"kind":"Variable","name":{"kind":"Name","value":"formType"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"is_enabled"}},{"kind":"Field","name":{"kind":"Name","value":"configurations"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"website_key"}},{"kind":"Field","name":{"kind":"Name","value":"badge_position"}}]}}]}}]}}]} as unknown as DocumentNode<GetRecaptchaConfigQuery, GetRecaptchaConfigQueryVariables>;
export const GetHeaderCustomerDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetHeaderCustomer"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"customer"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"firstname"}},{"kind":"Field","name":{"kind":"Name","value":"lastname"}}]}}]}}]} as unknown as DocumentNode<GetHeaderCustomerQuery, GetHeaderCustomerQueryVariables>;
export const GetBasicCustomerInfoDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetBasicCustomerInfo"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"customer"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"firstname"}}]}}]}}]} as unknown as DocumentNode<GetBasicCustomerInfoQuery, GetBasicCustomerInfoQueryVariables>;
export const GetNavigationMenuDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetNavigationMenu"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"categories"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"items"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"children_count"}},{"kind":"Field","name":{"kind":"Name","value":"children"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"uid"}},{"kind":"Field","name":{"kind":"Name","value":"level"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"url_path"}},{"kind":"Field","name":{"kind":"Name","value":"url_key"}},{"kind":"Field","name":{"kind":"Name","value":"position"}},{"kind":"Field","name":{"kind":"Name","value":"children_count"}},{"kind":"Field","name":{"kind":"Name","value":"children"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"uid"}},{"kind":"Field","name":{"kind":"Name","value":"level"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"url_path"}},{"kind":"Field","name":{"kind":"Name","value":"url_key"}},{"kind":"Field","name":{"kind":"Name","value":"position"}}]}}]}}]}}]}}]}}]} as unknown as DocumentNode<GetNavigationMenuQuery, GetNavigationMenuQueryVariables>;
export const GetStoreConfigDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetStoreConfig"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"storeConfig"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"header_logo_src"}},{"kind":"Field","name":{"kind":"Name","value":"logo_alt"}},{"kind":"Field","name":{"kind":"Name","value":"logo_height"}},{"kind":"Field","name":{"kind":"Name","value":"logo_width"}}]}},{"kind":"Field","name":{"kind":"Name","value":"availableStores"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"AvailableStoreFragment"}}]}},{"kind":"Field","name":{"kind":"Name","value":"currency"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"CurrencyFragment"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"AvailableStoreFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"StoreConfig"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"store_code"}},{"kind":"Field","name":{"kind":"Name","value":"store_name"}},{"kind":"Field","name":{"kind":"Name","value":"is_default_store"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"CurrencyFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Currency"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"available_currency_codes"}},{"kind":"Field","name":{"kind":"Name","value":"default_display_currency_code"}}]}}]} as unknown as DocumentNode<GetStoreConfigQuery, GetStoreConfigQueryVariables>;