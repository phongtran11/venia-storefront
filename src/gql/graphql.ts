...
export type GetHeaderStoreConfigQueryVariables = Exact<{ [key: string]: never; }>;


export type GetHeaderStoreConfigQuery = { __typename?: 'Query', storeConfig: { __typename?: 'StoreConfig', header_logo_src: string | null, logo_alt: string | null, logo_height: number | null, logo_width: number | null } | null, availableStores: Array<(
    { __typename?: 'StoreConfig' }
