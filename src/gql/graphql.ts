...
export type GetNavigationDataQuery = { __typename?: 'Query', categories: { __typename?: 'CategoryResult', items: Array<{ __typename?: 'CategoryTree', children_count: string | null, children: Array<{ __typename?: 'CategoryTree', uid: string, level: number | null, name: string | null, url_path: string | null, url_key: string | null, position: number | null, children_count: string | null, children: Array<{ __typename?: 'CategoryTree', uid: string, level: number | null, name: string | null, url_path: string | null, url_key: string | null, position: number | null } | null> | null } | null> | null } | null> | null } | null };

export type StoreLogoFragmentFragment = { __typename?: 'StoreConfig', header_logo_src: string | null, logo_alt: string | null, logo_height: number | null, logo_width: number | null, base_url: string | null } & { ' $fragmentName'?: 'StoreLogoFragmentFragment' };
...
export type GetStoreConfigQuery = { __typename?: 'Query', storeConfig: (
    { __typename?: 'StoreConfig' }
    & { ' $fragmentRefs'?: { 'StoreLogoFragmentFragment': StoreLogoFragmentFragment } }
...
export const StoreLogoFragmentFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"StoreLogoFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"StoreConfig"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"header_logo_src"}},{"kind":"Field","name":{"kind":"Name","value":"logo_alt"}},{"kind":"Field","name":{"kind":"Name","value":"logo_height"}},{"kind":"Field","name":{"kind":"Name","value":"logo_width"}},{"kind":"Field","name":{"kind":"Name","value":"base_url"}}]}}]} as unknown as DocumentNode<StoreLogoFragmentFragment, unknown>;
